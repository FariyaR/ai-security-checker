...
// // // GitHub service import (you'll need to create this)
// // let GitHubService;
// // try {
...
// //                 {
// //                     role: "system",
// //                     content: "You are a security expert. Analyze code for vulnerabilities and return only valid JSON."
// //                 },
// //                 {
// //                     role: "user",
// //                     content: prompt
...
// //     } catch (error) {
// //         console.log(`GPT-5 API error: ${error.message}`);
...
// //                     severity: "Critical",
// //                     line: 13,
// //                     description: "Database connection string contains hardcoded credentials, exposing sensitive information.",
...
// //                     severity: "Medium",
// //                     line: 25,
// //                     description: "Session token generation is predictable and may leak sensitive information.",
...
// //                     fix: "Use textContent instead of innerHTML, or sanitize HTML input."
// //                 },
// //                 {
// //                     title: "Prototype Pollution",
// //                     severity: "High",
// //                     line: 8,
// //                     description: "Object properties are set without proper validation, allowing prototype pollution.",
...
// //                     fix: "Use configuration files or environment variables for credentials."
// //                 },
// //                 {
// //                     title: "Resource Leak",
// //                     severity: "Medium",
...
// //         // Analyze each file with GPT-5 (limit to 20 files for demo)
...
// //                 // Skip very large files (>50KB for better GPT-5 performance)
...
//         // Update fallback analysis function to return consistent risk scores:
//         function fallbackAnalysis(filename) {
//             if (filename.endsWith('.py')) {
//                 return {
//                     vulnerabilities: [
...
//                         }
//                     ],
//                     // Add summary for consistent response
//                     summary: {
//                         risk_score: 85 // High risk due to 2 critical, 1 high, 2 medium, 1 low
//                     }
//                 };
//             } else if (filename.endsWith('.js')) {
//                 return {
...
//                     ],
//                     summary: {
//                         risk_score: 38 // 2 high + 1 medium = 30 + 8 = 38
//                     }
//                 };
//             } else if (filename.endsWith('.java')) {
//                 return {
...
//                     ],
//                     summary: {
//                         risk_score: 58 // 2 critical + 1 medium = 50 + 8 = 58
//                     }
//                 };
//             } else {
//                 return { 
//                     vulnerabilities: [],
//                     summary: {
//                         risk_score: 0 // No vulnerabilities = no risk
//                     }
//                 };
//             }
//         }
...
//         // Calculate risk score (lower is better, 0-100 scale)
//         // More vulnerabilities = higher risk score
//         const riskScore = Math.min(100, (criticalCount * 25) + (highCount * 15) + (mediumCount * 8) + (lowCount * 3));
//         const securityScore = Math.max(0, 100 - riskScore); // Security score (higher is better)
...
//                 low: lowCount,
//                 security_score: securityScore,
//                 risk_score: riskScore // This is what frontend expects
//             }
//         };
//         scanHistory.push(scanResult);
